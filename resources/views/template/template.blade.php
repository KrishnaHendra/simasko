...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-icon" href="images\logo_blk.png">
  ...
  <div class="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-light px-0">
      ...
      <a class="navbar-brand logo" href="{{ url('/') }}">
        <img loading="lazy" class="logo-default" src="{{'assets/'}}images\simasko-black.png" alt="logo" style="height:25px !important;">
        <img loading="lazy" class="logo-white" src="{{'assets/'}}images\simasko-white.png" alt="logo" style="height:25px !important;">
      </a>
      <!-- /logo -->
        ...
        <ul class="navbar-nav ml-auto text-center">
          ...
          <li class="nav-item {{ ($active == 'profile') ? 'active' : '' }}">
            <a class="nav-link" href="{{ url('/profile') }}">Profile</a>
		      ...
		      <li class="nav-item dropdown {{ ($active == 'strukturOrganisasi' || $active == 'daftarKejuruan' || $active == 'pengumuman') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown02">
              <li><a class="dropdown-item {{ ($active == 'strukturOrganisasi') ? 'active' : '' }}" href="{{ url('/strukturOrganisasi') }}">Struktur Organisasi</a></li>
              <li><a class="dropdown-item {{ ($active == 'daftarKejuruan') ? 'active' : '' }}" href="{{ url('/daftarKejuruan') }}">Daftar Kejuruan</a></li>
              <li><a class="dropdown-item {{ ($active == 'pengumuman') ? 'active' : '' }}" href="{{ url('/pengumuman') }}">Pengumuman</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown {{ ($active == 'syaratDanKetentuan' || $active == 'kebijakanPrivasi') ? 'active' : '' }}">
            <a class="nav-link dropdown-toggle" href="#!" id="navbarDropdown02" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Ketentuan & Kebijakan <i class="tf-ion-chevron-down"></i>
            </a>
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown02">
              <li><a class="dropdown-item {{ ($active == 'syaratDanKetentuan') ? 'active' : '' }}" href="{{ url('/sk') }}">Syarat dan Ketentuan</a></li>
              <li><a class="dropdown-item {{ ($active == 'kebijakanPrivasi') ? 'active' : '' }}" href="{{ url('/kebijakanPrivasi') }}">Kebijakan Privasi</a></li>
            </ul>
          </li>
          ...
          <li class="nav-item {{ ($active == 'alumni') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown02">
              <li><a class="dropdown-item {{ ($active == 'login') ? 'active' : '' }}" href="{{ url('/login') }}">Login</a></li>
              <li><a class="dropdown-item {{ ($active == 'register') ? 'active' : '' }}" href="{{ url('/register') }}">Register</a></li>
            </ul>
          </li>
        </ul>
      </div>
...
<footer id="footer" class="bg-one">
  ...
  <div class="footer-bottom">
    ...
    <h6>Design and Developed by <a href="#">SIMASKO</a></h6>
  </div>
</footer> <!-- end footer -->
